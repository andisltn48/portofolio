...
<html lang="en">
<head>
	<title>Portofolio Andi</title>
	<meta charset="utf-8">
	<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
	<link rel="stylesheet" href="/rezume-master/css/animate.css">
	<link rel="stylesheet" href="/rezume-master/css/flexslider.css">
	<link rel="stylesheet" href="/rezume-master/fonts/icomoon/style.css">

	<link rel="stylesheet" href="/rezume-master/css/bootstrap.css">
	<link rel="stylesheet" href="/rezume-master/css/style.css">
...
<body data-spy="scroll" data-target="#pb-navbar" data-offset="200">
	...
	<script src="/rezume-master/js/vendor/jquery.min.js"></script>
	<script src="/rezume-master/js/vendor/jquery-migrate-3.0.1.min.js"></script>
	<script src="/rezume-master/js/vendor/popper.min.js"></script>
	<script src="/rezume-master/js/vendor/bootstrap.min.js"></script>

	<script src="/rezume-master/js/vendor/jquery.easing.1.3.js"></script>

	<script src="/rezume-master/js/vendor/jquery.stellar.min.js"></script>
	<script src="/rezume-master/js/vendor/jquery.waypoints.min.js"></script>

	<script src="https://unpkg.com/isotope-layout@3/dist/isotope.pkgd.min.js"></script>
	<script src="https://unpkg.com/imagesloaded@4/imagesloaded.pkgd.min.js"></script>
	<script src="/rezume-master/js/custom.js"></script>
